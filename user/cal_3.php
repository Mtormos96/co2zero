...
<head>
    ...
    <title>Calculadora Alcance 3</title>
    <style>
        body {
...
<section>
    <h2>Bienvenido a la calculadora del alcance 3</h2>
    <p>FUNCIONAMIENTO DE LA CALCULADORA + DESCRIPCION</p>
    <!-- AQUI IRA EL CODIGODE LA CALCULADORA -->
    <div id="calculadora">
        <div id="encabezado">
            <h2>Calculadora Alcance 3</h2>
        </div>
        <div id="contenido">
        ...
        <div id="pie">
            <p>Derechos de autor © 2024 - Calculadora alcance 3</p>
        </div>
    </div>
...
<footer>
    <p>Derechos de autor © 2024 - cal_3</p>
</footer>
